...
const COMPANY = {
  ...
  tagline: 'Govt. Registered · MSME Certified',
  email: 'umarian7@gmail.com',
  address: '7/273, Malayadivaram, Chettikulam, Alathur, Perambalur, Tamil Nadu',
  whatsapp: '9941489330',
  phone: '9843139330',
};
...
const Pin = () => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" style={{ flexShrink: 0, marginTop: 2 }}>
        ...
        <div className="footer-premium-grid">
          ...
          <div className="footer-brand-col">
            ...
            <p className="footer-description">
              Empowering students across Tamil Nadu with expert admission guidance,
              scholarship support, and personalised career counselling since 2024.
          ...
          <div className="footer-links-col">
            <h4>Explore</h4>
            <ul>
              <li><Link to="/colleges">Branch Colleges</Link></li>
