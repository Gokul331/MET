    ...
    const SECTIONS = [
        {
            ...
            fields: [
                ...
                { label: 'Mobile Number', value: app.mobile },
                { label: 'Email ID', value: app.email },
                { label: 'Blood Group', value: app.blood_group },
                { label: 'Community', value: app.community },
                { label: 'Aadhar Number', value: app.aadhar_number },
            ],
        },
        {
            ...
            icon: '👨‍👩‍👦',
            fields: [
                { label: 'Father Name', value: app.father_name },
                { label: 'Father Mobile', value: app.father_mobile },
                { label: 'Mother Name', value: app.mother_name },
                { label: 'Mother Mobile', value: app.mother_mobile },
            ],
        },
        {
            title: 'Address',
            icon: '📍',
            fields: [
                { label: 'Address Line 1', value: app.address_line1 },
                { label: 'Address Line 2', value: app.address_line2 },
        ...
        },
        {
            ...
            icon: '📚',
            fields: [
                { label: 'Tenth Marks Percentage', value: app.tenth_percentage ? `${app.tenth_percentage}%` : null },
                { label: 'Twelfth Marks Percentage', value: app.twelfth_percentage ? `${app.twelfth_percentage}%` : null },
                { label: 'Has Diploma', value: app.has_diploma ? 'Yes' : 'No' },
                { label: 'Diploma Marks Percentage', value: app.has_diploma && app.diploma_percentage ? `${app.diploma_percentage}%` : null },
                { label: 'Has UG', value: app.has_ug ? 'Yes' : 'No' },
                { label: 'UG Marks Percentage', value: app.has_ug && app.ug_percentage ? `${app.ug_percentage}%` : null },
            ],
        },
        {
            title: 'College & Course Preference',
            icon: '🏛️',
            fields: [
                { label: 'College', value: app.college_name },
                { label: 'Category', value: app.category },
                { label: 'Course Name', value: app.course_name },
                { label: 'Department Name', value: app.department_name },
            ],
        },
        {
            ...
            icon: '🤝',
            fields: [
                { label: 'Reference Name', value: app.reference_name },
            ],
        },
    ];
        ...
        <PageTransition>
            ...
            <section className="application-detail-hero">
                <div className="container">
                    <Link to="/applications" className="back-link">← All Applications</Link>
                    ...
                    <div className="detail-content-grid">
                        <div className="detail-main">
                            ...
                            {status === 'rejected' && app.rejection_reason && (
                                <div className="detail-card rejection-card">
                                    ...
                                    <Link to="/apply" className="btn-dark">Reapply Now</Link>
                                </div>
                            )}
                        </div>
                        ...
                        <aside className="detail-sidebar">
                            <div className="detail-card sidebar-card">
                                ...
                                <Link to="/applications" className="btn-outline w-full" style={{ marginTop: '8px', display: 'block', textAlign: 'center' }}>
                                    ← All Applications
                                </Link>
                            </div>
